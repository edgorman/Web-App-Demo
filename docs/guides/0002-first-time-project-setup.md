...
4. Create a service account for executing Terraform configuration:
...
5. Grant the service account permissions to provision:
...
6. Create and download the key file for the new service account:
